...
// Get user's chats
router.get('/chats', async (req: AuthenticatedRequest, res) => {
  try {
...
// Get chat messages
router.get('/chats/:chatId/messages', async (req: AuthenticatedRequest, res) => {
  try {
...
// Create new chat
router.post('/chats', async (req: AuthenticatedRequest, res) => {
  try {
...
router.get('/chats/:chatId/keys', async (req: AuthenticatedRequest, res) => {
  try {
    const { chatId } = req.params;
    const userId = req.user?.id;
    ...
    res.json({
      ...
      memberKeys: chat.members.map((member: any) => ({
...
router.post('/chats/:chatId/keys', async (req: AuthenticatedRequest, res) => {
  try {
    const { chatId } = req.params;
